...
// Explanation
// Instantiate an array variable which is the string split into its elements using the .split() method
// Instantiate a while loop from the number 1, (i), to the given number, (n)
// If the loop counter (i) is even, push an asterisk * to the end of the array
// If the loop counter (i) is odd, unshift an asterisk * to the beginning of the array
// For each loop, add 1 to (i) to continue to the next iteration
// At the end of all loops, return the array joined as a string using the .join() method.
