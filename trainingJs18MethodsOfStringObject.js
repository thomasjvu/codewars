...
// Explanation
// Split the string into array elements using the .split(" ") method with a space as the separator
// Then, map the array and for each index, split it by the character ('')
// Then, join the inner arrays with the .join(separator) method
// Finally, join that array together into a string, and return that final result
