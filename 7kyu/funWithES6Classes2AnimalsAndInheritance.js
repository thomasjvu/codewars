...
// Explanation
// Put all variables relevant to each class in the constructor as parameters.
// For predefined values, use this.property = some value
// For user-defined values, use this.property = property
// Within a class, define functions directly under the class
