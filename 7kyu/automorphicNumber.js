...
const automorphic = n => {
    str = String(n)
    squareStr = String(n**2)

    if (squareStr.endsWith(str)) {
        return 'Automorphic'
    } else {
        return 'Not!!'
    }
...
// Explanation
// Use the String() constructor to create a new string variable from the given number.
// Use the String() constructor to create a new string variable from the given number squared.
// Use an if..else conditional to check if the squared string .endsWith() the string.
// If it does, return 'Automorphic'
// If it doesn't, return 'Not!!'
