...
// Explanation
// Use the modulus operator to check if an element is even by checking if the remainder is 0 when divided by 2.
// For each element in the array, if the element is even, use the `.push()` method on the even array to push the element to the end of the array
// Or else the element must be odd, in which case we use the `.push()` method on the odd array to push the element to the end of the array
